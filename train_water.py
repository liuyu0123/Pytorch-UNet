...
class CSVLogger:
    ...
    def save(self):
        ...
        logging.info(f"Training log saved to {self.save_path}")
...
def train_model(
    ...
    info_path = log_dir / 'model_info.txt'
    ...
    for epoch in range(1, epochs + 1):
        ...
        if val_metrics['miou'] > best_miou:
            ...
            if save_checkpoint:
                ...
                torch.save(state_dict, dir_checkpoint / 'checkpoint_best.pth')
...
if __name__ == '__main__':
    ...
    try:
        train_model(model=model, device=device, dir_img=dir_img, dir_mask=dir_mask,
                   dir_val_img=dir_val_img, dir_val_mask=dir_val_mask,
                   mask_suffix=args.mask_suffix, epochs=args.epochs,
                   batch_size=args.batch_size, learning_rate=args.lr,
                   img_scale=args.scale, val_percent=args.val / 100,
                   amp=args.amp, num_workers=args.workers,
